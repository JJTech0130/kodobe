...
local x509_vfy_macro = require "openssl.include.x509_vfy"
local x509_lib = require "openssl.x509"
local chain_lib = require "openssl.x509.chain"
local crl_lib = require "openssl.x509.crl"
local ctx_lib = require "openssl.ctx"
local format_error = require("openssl.err").format_all_error
local format_all_error = require("openssl.err").format_error
