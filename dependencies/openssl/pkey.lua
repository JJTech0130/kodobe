...
local rsa_macro = require "openssl.include.rsa"
local dh_macro = require "openssl.include.dh"
require "openssl.include.bio"
require "openssl.include.pem"
require "openssl.include.x509"
require "openssl.include.evp.pkey"
local evp_macro = require "openssl.include.evp"
local pkey_macro = require "openssl.include.evp.pkey"
local util = require "openssl.util"
local digest_lib = require "openssl.digest"
local rsa_lib = require "openssl.rsa"
local dh_lib = require "openssl.dh"
local ec_lib = require "openssl.ec"
local ecx_lib = require "openssl.ecx"
local objects_lib = require "openssl.objects"
local jwk_lib = require "openssl.auxiliary.jwk"
local ctx_lib = require "openssl.ctx"
local ctypes = require "openssl.auxiliary.ctypes"
local format_error = require("openssl.err").format_error

local OPENSSL_11_OR_LATER = require("openssl.version").OPENSSL_11_OR_LATER
local OPENSSL_111_OR_LATER = require("openssl.version").OPENSSL_111_OR_LATER
local OPENSSL_30 = require("openssl.version").OPENSSL_30
...
if OPENSSL_30 then
  local param_lib = require "openssl.param"
